...
@Observable
final class FTPFileDataProvider: FileDataProviderProtocol {
    ...
    private func scanFilesForURL(rootURL: URL, filePath: String) {
        ...
        DispatchQueue.global(qos: .userInitiated).async { [weak self] in
            ...
            // Start listening to file systems changes for this folder.
    ...
    // Fetch files, sorted by folders first, then files, and all alphabetically.
